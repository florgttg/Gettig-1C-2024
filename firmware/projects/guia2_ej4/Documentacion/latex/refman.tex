...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Proyecto 2 actividad 4},%
      pdfsubject={Conversion analogico digitsl y viceversa}%
    }
...
\input{index}
\input{md__c_1_2_repositorios_2_gettig-1_c-2024_2firmware_2projects_2guia2__ej4_2_r_e_a_d_m_e}
\chapter{Topic Index}
\input{topics}
...
\input{_gettig-1_c-2024_2firmware_2projects_2guia2__ej4_2_c_make_lists_8txt}
\input{_gettig-1_c-2024_2firmware_2projects_2guia2__ej4_2main_2_c_make_lists_8txt}
\input{guia2__ej4_8c}
\input{guia2__ej4_8c_source}
