...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Proyecto Integrador},%
      pdfsubject={Gamificacion de ejerciocios de fisioterapia}%
    }
...
\input{index}
\input{md__c_1_2_repositorios_2_gettig-1_c-2024_2firmware_2projects_2proyecto__integrador_2_proyecto_flappy_2_r_e_a_d_m_e}
\input{md__c_1_2_repositorios_2_gettig-1_c-2024_2firmware_2projects_2proyecto__integrador_2_r_e_a_d_m_e}
\chapter{Topic Index}
\input{topics}
...
\input{classmain_1_1_bird}
\input{structble__config__t}
\input{structchar__info__t}
\input{struct_c_m_d__t}
\input{structdigital__io__t}
\input{unionesp__hidd__cb__param__t}
\input{struct_font__t}
\input{structgatts__profile__inst}
\input{structhid__dev__cfg__t}
\input{structhid__report__map__t}
\input{structhidd__clcb__t}
\input{structesp__hidd__cb__param__t_1_1hidd__connect__evt__param}
\input{structesp__hidd__cb__param__t_1_1hidd__deinit__finish__evt__param}
\input{structesp__hidd__cb__param__t_1_1hidd__disconnect__evt__param}
\input{structhidd__feature__t}
\input{structesp__hidd__cb__param__t_1_1hidd__init__finish__evt__param}
\input{structhidd__inst__t}
\input{structhidd__le__env__t}
\input{structesp__hidd__cb__param__t_1_1hidd__led__write__evt__param}
\input{structesp__hidd__cb__param__t_1_1hidd__vendor__write__evt__param}
\input{structhid_rpt_map__t}
\input{structhids__hid__info__t}
\input{structhids__report__ref__t}
\input{structicon__font__t}
\input{structlcd__cmd__t}
\input{structorientation__properties__t}
\input{classmain_1_1_pipe}
\input{structprf__char__pres__fmt}
...
\input{buzzer__melodies_8h}
\input{buzzer__melodies_8h_source}
\input{fonts_8h}
...
\input{icons_8h}
\input{icons_8h_source}
\input{ili9341_8h}
\input{ili9341_8h_source}
\input{l293_8h}
\input{l293_8h_source}
...
\input{ble__hid__mcu_8h}
\input{ble__hid__mcu_8h_source}
\input{ble__mcu_8h}
\input{ble__mcu_8h_source}
\input{delay__mcu_8h}
...
\input{ble__hid__mcu_8c}
\input{ble__hid__mcu_8c_source}
\input{ble__mcu_8c}
\input{ble__mcu_8c_source}
\input{delay__mcu_8c}
...
\input{_e_programable___f_i_u_n_e_r_2firmware_2drivers_2_c_make_lists_8txt}
\input{_gettig-1_c-2024_2firmware_2projects_2proyecto__integrador_2_c_make_lists_8txt}
\input{_gettig-1_c-2024_2firmware_2projects_2proyecto__integrador_2main_2_c_make_lists_8txt}
\input{proyecto__integrador_8c}
\input{proyecto__integrador_8c_source}
\input{main_8py}
\input{main_8py_source}
\input{_proyecto_flappy_2_r_e_a_d_m_e_8md}
